...
export default function Hero({ onScrollTo }) {
  ...
  return (
    <section id="hero" className="section hero" ref={sectionRef}>
      <div className={`hero-inner${visible ? ' hero-inner--visible' : ''}`}>
        {/* Left column */}
        <div className="hero-left">
          ...
          {/* Name */}
          <div className="hero-name animate-child" style={{ animationDelay: '80ms' }}>
          ...
          {/* CTAs */}
          <div className="hero-ctas animate-child" style={{ animationDelay: '240ms' }}>
            <button
          ...
          {/* Social strip */}
          <div className="hero-social animate-child" style={{ animationDelay: '320ms' }}>
