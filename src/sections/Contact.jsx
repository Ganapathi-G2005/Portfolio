...
const SOCIAL_LINKS = [
  {
    label: 'GitHub',
    handle: '@Ganapathi-G2005',
    href: 'https://github.com/Ganapathi-G2005',
    icon: (
  ...
  },
  {
    label: 'LinkedIn',
    handle: 'ganapathi-g',
    href: 'https://www.linkedin.com/in/ganapathi-g-369a20355/',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'WhatsApp',
    handle: '+91 93470 76225',
    href: 'https://wa.me/919347076225',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    label: 'Email',
    handle: 'ganapathi.gadagamma@gmail.com',
    href: 'mailto:ganapathi.gadagamma@gmail.com',
    icon: (
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus('error')
      setErrMsg(err?.text || 'something went wrong, try again.')
    }
  }

  return (
    <section id="contact" className={`section contact${visible ? ' contact--visible' : ''}`} ref={sectionRef}>
      <div className="contact-inner">
        ...
        <div className="contact-left animate-child">
          ...
          <div className="contact-heading">
            ...
            <br />
            <span className="contact-h1 contact-h1--accent">BUILD.</span>
          </div>
          <p className="contact-sub">
            Open to internships, collabs, and interesting problems.
            Response time: not terrible.
          </p>
        ...
        {/* Right column — form */}
        <div className="contact-right animate-child" style={{ animationDelay: '100ms' }}>
          {status === 'success' ? (
